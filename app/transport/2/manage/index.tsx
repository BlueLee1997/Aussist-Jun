        ...
        <ScrollView style={styles.scrollView}>
          <View style={styles.contentContainer}>
            ...
            <View style={styles.downloadSection}>
              <Text style={styles.downloadTitle}>Download the Opal Travel app</Text>
              <View style={styles.downloadContainer}>
                <TouchableOpacity
                  onPress={() => Linking.openURL('https://apps.apple.com/au/app/opal-travel/id941006607')}
                ...
                <TouchableOpacity
                  onPress={() => Linking.openURL('https://play.google.com/store/apps/details?id=au.com.opal.travel&hl=en&pli=1')}
                  style={styles.textStoreButton}
                >
                  <Image
